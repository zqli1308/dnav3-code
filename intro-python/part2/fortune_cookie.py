...
def create_fortune_cookie_message(how_many_lucky_numbers: int) -> str:
    ...
    # cookie's message.
    The_lucky_numbers=generate_lucky_numbers(how_many_lucky_numbers)
    #print(The_lucky_numbers)
    The_fortun_message=[]
    for The_lucky_number in The_lucky_numbers:

        The_fortun_message.append((str(The_lucky_number)+'.'+generate_fortune()))

        #print('Your fortune number is {}'.format(The_lucky_number),The_fortun_message)
    return The_fortun_message
